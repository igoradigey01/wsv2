...
export class CatalogItemComponent {
  ...
  private state = signal<Katalog>(<Katalog>{id:0,hidden:false,decriptSEO:"",name:'none',ownerId:"none"});
  ...
  //--------------------------------
  public save(): void {
    this.catalogModified.emit(   <EmitData>{catalog:this.Katalog(),stateView:this._falg});
  ...
  public cancel() {
    // debugger
    this.catalogModified.emit(   <EmitData>{catalog:this.Katalog(),stateView: StateView.exit});
  }
